...
export const About = () => {
  return (
    <div className="flex flex-col justify-center items-center w-full mt-20 gap-10">
      <h1 className="font-monoton text-2xl md:text-6xl mb-4">About us</h1>
      <BlobCursor>
        <div className="flex justify-center items-center w-full gap-14 flex-wrap mt-20 z-10">
          <WordFadeIn
          ...
          />
          <Image src="/logo.png" width={400} height={200} alt="college logo" />
        </div>
      </BlobCursor>
      <div className="flex justify-center items-center w-full gap-14 flex-wrap mt-20 z-10">
