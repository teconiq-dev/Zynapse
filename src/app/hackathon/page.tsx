...
function HeroSection() {
    return (
        ...
        >
            <div
                className="text-center bg-background/70 backdrop-blur-md p-5 py-14 rounded-xl shadow-md shadow-purple-500">
...
export function PrizeSchema({
    ...
    return (
        <div
            className={cn(
                "relative flex h-[420px] w-full flex-col overflow-hidden rounded-lg border bg-background p-6" +
                " md:shadow-xl",
                className,
            )}
        >
            <h1 className={"text-3xl md:text-4xl font-bold text-center mb-12 font-audioWide"}>
                Prize Schema
            </h1>
