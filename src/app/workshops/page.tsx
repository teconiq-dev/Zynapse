...
{/* for register button acertinity  */
}
...
export default function Workshop() {
    const features = [
        ...
        },
        {
            title: "Power BI",
            description:
                "Learn new skills with Power BI",
        ...
        <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
            <div className="px-8">
                ...
                <p className="text-sm lg:text-base  max-w-2xl  my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
                    From UI/UX to Blockchain and Game development to Business Intelligence we got it all.
                    Our workshops cover everything you need to know for your adventure in industry.
                </p>
                <HyperText className="text-5xl py-10" text={"Our Workshops:"}/>
            </div>
...
export const SkeletonThree = () => {
    return (
        <BackgroundGradient className="rounded-[22px] p-4 sm:p-10 bg-white dark:bg-zinc-900">
            <Link
                href="https://youtu.be/SSo_EIwHSd4?si=V2r0AsB9oTxMTNS0"
                target="__blank"
...
export const SkeletonFour = () => {
    return (
        <BackgroundGradient className="rounded-[22px] p-4 sm:p-10 bg-white dark:bg-zinc-900">
            <div>
                <p>
                    PowerBi consist of analysing business with computer ,angane enthokeyo aaan.
                </p>
            </div>
